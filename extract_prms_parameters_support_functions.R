...
#' 
#' Function adapted from: https://github.com/cneyens/prms/blob/master/R/read_prms_parms.R
#' 
...
read_prms_parms = function(param_path_calib = param_path_calib, 
                           param_path_gis_derived = param_path_gis_derived,
                           param_path_default = param_path_default,
                           param_path_cascade = param_path_cascade){
  
  # read in parameter files
  lines_calib = readLines(param_path_calib)
  lines_gis_derived = readLines(param_path_gis_derived)
  lines_default = readLines(param_path_default)
  lines_cascade = readLines(param_path_cascade)
  
  # combine all parameter files into one file
  lines <- c(lines_calib, lines_gis_derived, lines_default, lines_cascade)
