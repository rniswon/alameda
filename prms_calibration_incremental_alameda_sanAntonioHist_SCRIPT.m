...
projectFolder = 'C:\gsflow_onlyPRMS_SanAntonio'; % Will need to change this if running from other locations
...
N0 = 1; %Initial simulation
N = 2; % Final simulation
N1 = 2; % Set how many simulations to run before summary file is generated - should be equal to the number of multipliers in a spreadsheet
