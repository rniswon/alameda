...
call 03_Sub.Create_Factors_For_Spat_Interp_lay1_K.bat     %1      ..\SurfK_PP_List.txt      ..\SurfK_Zone_Arr.txt           Struct_File.%2.Variogram.txt   ..\Alameda-Interpolated_%2_By_ppk2fac.txt      %2       30000.0
