...
call 02_Sub.PP2Layer.bat      .\Alameda-Interpolated_%1_%2_By_ppk2fac.txt    .\%6_K_PP_List.txt      ..\upw_support\Kh_%6.txt 
cd ..\upw_support\
...
call 02_Sub.PP2Layer.bat      .\Alameda-Interpolated_%1_%3_By_ppk2fac.txt    .\%7_K_PP_List.txt      ..\upw_support\Kh_%7.txt  
cd ..\upw_support\
echo  702  771        >   RefArr_In.txt
...
call 02_Sub.PP2Layer.bat      .\Alameda-Interpolated_%1_%4_By_ppk2fac.txt    .\%8_K_PP_List.txt      ..\upw_support\Kh_%8.txt 
cd ..\upw_support\
echo   702  771       >   RefArr_In.txt
echo  Kh_%8.txt      >>   RefArr_In.txt
call ReformArray.exe  <   RefArr_In.txt
cd ..\pest\


REM For Hydraulic conductivity of layer 4
REM -------------------------------------

call 02_Sub.PP2Layer.bat      .\Alameda-Interpolated_%1_%5_By_ppk2fac.txt    .\%9_K_PP_List.txt      ..\upw_support\Kh_%9.txt 
cd ..\upw_support\
echo   702  771       >   RefArr_In.txt
echo  Kh_%9.txt      >>   RefArr_In.txt
call ReformArray.exe  <   RefArr_In.txt
cd ..\pest\
